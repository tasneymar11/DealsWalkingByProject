...
//    private final View.OnClickListener mOnClickListener = new MyOnClickListener();
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.new_deal_row_structure, null);
...
//        Button mDeleteButton;
        ImageButton mPromoCodeButton;

        public ProductViewHolder(final View itemView) {
            super(itemView);
            mPromoCodeButton = itemView.findViewById(R.id.newButtonGetPromo);
            deal_promo_code = itemView.findViewById(R.id.newtextViewPromoCode);
            deal_image_name = itemView.findViewById(R.id.newdeal_image_name);
            deal_title = itemView.findViewById(R.id.newdeal_title);
            deal_description = itemView.findViewById(R.id.newdeal_description);
            deal_longitude = itemView.findViewById(R.id.newdealActivity_longitude);
            deal_latitude = itemView.findViewById(R.id.newdealActivity_latitude);
            mImageView = itemView.findViewById(R.id.newdeal_image);
            deal_validity = itemView.findViewById(R.id.newdeal_validity);
            mImageButton = itemView.findViewById(R.id.newimageButton2);
//            mDeleteButton = itemView.findViewById(R.id.adminDeleteButton);
            deal_validity_day = itemView.findViewById(R.id.newtextViewDisplayDay);
            deal_validity_month = itemView.findViewById(R.id.newtextViewDisplayMonth);
            deal_validity_year = itemView.findViewById(R.id.newtextViewDisplayYear);
        }
